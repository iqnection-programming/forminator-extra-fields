...
/**
 * Class Forminator_Extra_HtmlMultiValue
 *
 * @since 1.0
 */
class Forminator_Extra_Html_Checkbox extends Forminator_Field {
	...
	public function __construct() {
		...
		$this->name = __( 'HTML Checkbox', 'forminator' );
	}
	...
	public function markup( $field, $settings = array() ) {
		...
		return apply_filters( 'forminator_field_htmlmultiple_markup', $html, $id, $required, $options, $value_type );
	}
	...
	public function get_validation_rules() {
		...
		return apply_filters( 'forminator_field_htmlmultiple_validation_rules', $rules, $id, $field );
	}
	...
	public function get_validation_messages() {
		...
		if ( $is_required ) {
			...
			$required_message = apply_filters(
				'forminator_htmlmulti_field_required_validation_message',
				$required_message,
				$id,
				$field
			);
	...
	public function sanitize( $field, $data ) {
		...
		return apply_filters( 'forminator_field_htmlmulti_sanitize', $data, $field, $original_data );
	}
	...
	public function get_calculable_value( $submitted_data, $field_settings ) {
		 ...
		 */
		$calculable_value = apply_filters( 'forminator_field_htmlmulti_calculable_value', $calculable_value, $submitted_data, $field_settings );
